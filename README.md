...
- Ejecutar la ingesta de datos (Bronze) - python -m src.ingestion.Ingestas
- Transformar datos (silver) - python -m src.transformation.silver_transform
- Generar metricas (Gold) - python -m src.transformation.gold_transform
- Visualizar datos (resumen de Kpis) -python -m src.Visualizacion.query_gold
...
- Bronze: capa de ingestión, datos crudos sin procesar.
...
- Consumo: los usuarios pueden consultar las métricas con SQL, DuckDB, PowerBI, etc.
...
- Modularidad:
   ...
   src/calidad/ → validaciones y logs
